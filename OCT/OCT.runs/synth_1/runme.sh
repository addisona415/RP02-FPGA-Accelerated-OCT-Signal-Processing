...
HD_PWD='A:/School/Capstone/OCT/OCT.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fftTest.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fftTest.tcl
