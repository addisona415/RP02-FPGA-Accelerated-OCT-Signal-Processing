...
HD_PWD='A:/School/Capstone/OCT/OCT.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fftTest.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fftTest.tcl -notrace
