-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\SDFCommutator1.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF1_1/SDFCommutator1
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator1 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL xf_im_signed                     : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL dinXTwdlf_re_signed              : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL dinXTwdlf_im_signed              : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL btf1_re_signed                   : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL btf1_im_signed                   : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL btf2_re_signed                   : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL btf2_im_signed                   : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL SDFCummutator_out_im_next        : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL wrData_re_tmp                    : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL wrData_im                        : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL wrAddr_tmp                       : unsigned(8 DOWNTO 0);  -- ufix9
  SIGNAL xData_re                         : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL xData_im                         : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL dout0_re                         : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL dout0_im                         : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL xX_re_signed                     : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL xX_im                            : std_logic_vector(32 DOWNTO 0);  -- ufix33
  SIGNAL xX_im_signed                     : signed(32 DOWNTO 0);  -- sfix33_En28
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_1_1_re_tmp                  : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL dout_1_1_im_tmp                  : signed(32 DOWNTO 0);  -- sfix33_En28
