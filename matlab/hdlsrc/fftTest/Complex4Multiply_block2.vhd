-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\Complex4Multiply_block2.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF1_9/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block2 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL din_re_reg                       : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL din_im_signed                    : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL din_im_reg                       : signed(40 DOWNTO 0);  -- sfix41_En28
  ...
  SIGNAL prod1_re                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En58
  SIGNAL prod1_im                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En58
  SIGNAL prod2_re                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En58
  SIGNAL prod2_im                         : signed(72 DOWNTO 0) := to_signed(0, 73);  -- sfix73_En58
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL Complex4Add_sub_cast             : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL Complex4Add_sub_cast_1           : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL Complex4Add_add_cast             : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL Complex4Add_add_cast_1           : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL mulResFP_re                      : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL mulResFP_im                      : signed(73 DOWNTO 0);  -- sfix74_En58
  SIGNAL dinXTwdl_re_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL dinXTwdl_im_tmp                  : signed(40 DOWNTO 0);  -- sfix41_En28
