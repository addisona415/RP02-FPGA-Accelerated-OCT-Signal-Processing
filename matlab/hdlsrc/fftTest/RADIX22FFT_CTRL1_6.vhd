-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_6.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_6
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_6_Enb <= '0';
        IF dout_5_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#F#, 4)) THEN 
