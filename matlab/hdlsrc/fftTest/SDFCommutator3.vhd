-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\SDFCommutator3.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF1_3/SDFCommutator3
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator3 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL xf_im_signed                     : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL dinXTwdlf_re_signed              : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL dinXTwdlf_im_signed              : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL btf1_re_signed                   : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL btf1_im_signed                   : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL btf2_re_signed                   : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL btf2_im_signed                   : signed(34 DOWNTO 0);  -- sfix35_En28
  ...
  SIGNAL SDFCummutator_out_re_next        : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL SDFCummutator_out_im_next        : signed(34 DOWNTO 0);  -- sfix35_En28
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  ...
  SIGNAL wrData_re_tmp                    : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL wrData_im_tmp                    : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL wrAddr_tmp                       : unsigned(6 DOWNTO 0);  -- ufix7
  SIGNAL xData_re                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL xData_im                         : signed(34 DOWNTO 0);  -- sfix35_En28
  ...
  SIGNAL dout0_re                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL dout0_im                         : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL xX_re_signed                     : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL xX_im                            : std_logic_vector(34 DOWNTO 0);  -- ufix35
  SIGNAL xX_im_signed                     : signed(34 DOWNTO 0);  -- sfix35_En28
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_3_1_re_tmp                  : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL dout_3_1_im_tmp                  : signed(34 DOWNTO 0);  -- sfix35_En28
