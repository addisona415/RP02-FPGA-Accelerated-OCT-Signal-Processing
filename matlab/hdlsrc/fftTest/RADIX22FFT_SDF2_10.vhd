-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_SDF2_10.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF2_10
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_10 IS
  ...
  COMPONENT SDFCommutator10
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          dout_9_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          xf_im                           :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          dinf_im                         :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          btf1_im                         :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          btf2_re                         :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          btf2_im                         :   IN    std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
          wrData_im                       :   OUT   std_logic_vector(41 DOWNTO 0);  -- sfix42_En28
  ...
  -- Signals
  SIGNAL dout_9_1_re_signed               : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL din_re                           : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dout_9_1_im_signed               : signed(40 DOWNTO 0);  -- sfix41_En28
  SIGNAL din_im                           : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL saveEnb                          : std_logic;
  SIGNAL dinVld                           : std_logic;
  SIGNAL din_re_dly1                      : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btfin_re                         : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL din_im_dly1                      : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btfin_im                         : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL btf2_im                          : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf2_re                          : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf1_im                          : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf1_re                          : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dinf_im                          : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dinf_re                          : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL xf_im                            : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL x_im                             : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL x_im_dly                         : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL wrData_im                        : std_logic_vector(41 DOWNTO 0);  -- ufix42
  SIGNAL wrData_im_signed                 : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL wrData_re                        : std_logic_vector(41 DOWNTO 0);  -- ufix42
  SIGNAL wrData_re_signed                 : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL wrAddr                           : std_logic;  -- ufix1
  SIGNAL wrEnb                            : std_logic;
  SIGNAL twoLocationReg_0_MEM_re_0        : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL twoLocationReg_0_MEM_im_0        : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL twoLocationReg_0_MEM_re_1        : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL twoLocationReg_0_MEM_im_1        : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL twoLocationReg_0_dout_re_reg     : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL twoLocationReg_0_dout_im_reg     : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL twoLocationReg_0_MEM_re_0_next   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL twoLocationReg_0_MEM_im_0_next   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL twoLocationReg_0_MEM_re_1_next   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL twoLocationReg_0_MEM_im_1_next   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL twoLocationReg_0_dout_re_reg_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL twoLocationReg_0_dout_im_reg_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL x_re                             : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL x_re_dly                         : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En28
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En28
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(42 DOWNTO 0);  -- sfix43_En28
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(42 DOWNTO 0);  -- sfix43_En28
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(41 DOWNTO 0);  -- sfix42_En28
...
BEGIN
  u_SDFCOMMUTATOR_10 : SDFCommutator10
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix42_En28
              xf_im => std_logic_vector(xf_im),  -- sfix42_En28
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix42_En28
              dinf_im => std_logic_vector(dinf_im),  -- sfix42_En28
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix42_En28
              btf1_im => std_logic_vector(btf1_im),  -- sfix42_En28
              btf2_re => std_logic_vector(btf2_re),  -- sfix42_En28
              btf2_im => std_logic_vector(btf2_im),  -- sfix42_En28
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix42_En28
              wrData_im => wrData_im,  -- sfix42_En28
              wrAddr => wrAddr,  -- ufix1
              wrEnb => wrEnb,
              dout_10_1_re => dout_10_1_re_tmp,  -- sfix42_En28
              dout_10_1_im => dout_10_1_im_tmp,  -- sfix42_En28
  ...
  BEGIN
    IF reset = '1' THEN
      twoLocationReg_0_MEM_re_0 <= to_signed(0, 42);
      twoLocationReg_0_MEM_im_0 <= to_signed(0, 42);
      twoLocationReg_0_MEM_re_1 <= to_signed(0, 42);
      twoLocationReg_0_MEM_im_1 <= to_signed(0, 42);
      twoLocationReg_0_dout_re_reg <= to_signed(0, 42);
      twoLocationReg_0_dout_im_reg <= to_signed(0, 42);
    ELSIF clk'EVENT AND clk = '1' THEN
      IF enb = '1' THEN
