-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\SDFCommutator10.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF2_10/SDFCommutator10
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF SDFCommutator10 IS
  ...
  -- Signals
  SIGNAL xf_re_signed                     : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL xf_im_signed                     : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dinf_re_signed                   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dinf_im_signed                   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf1_re_signed                   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf1_im_signed                   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf2_re_signed                   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL btf2_im_signed                   : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL SDFCummutator_btf1_re_dly        : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL SDFCummutator_btf1_im_dly        : signed(41 DOWNTO 0);  -- sfix42
  SIGNAL SDFCummutator_btf1_vld_dly       : std_logic;
  SIGNAL SDFCummutator_out_re_next        : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFCummutator_out_im_next        : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL SDFCummutator_wrData_re_reg_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFCummutator_wrData_im_reg_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFCummutator_wrEnb_reg_next     : std_logic;
  SIGNAL SDFCummutator_wrXData_re_reg_next : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFCummutator_wrXData_im_reg_next : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL SDFCummutator_btf1_re_dly_next   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFCummutator_btf1_im_dly_next   : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFCummutator_btf1_vld_dly_next  : std_logic;
  SIGNAL wrData_re_tmp                    : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL wrData_im_tmp                    : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL xData_re                         : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL xData_im                         : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL dout0_re                         : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dout0_im                         : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dout0_vld                        : std_logic;
  SIGNAL xX_re                            : std_logic_vector(41 DOWNTO 0);  -- ufix42
  SIGNAL xX_re_signed                     : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL xX_im                            : std_logic_vector(41 DOWNTO 0);  -- ufix42
  SIGNAL xX_im_signed                     : signed(41 DOWNTO 0);  -- sfix42_En28
  ...
  SIGNAL SDFOutmux_btf2Pipe_re_next       : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFOutmux_btf2Pipe_im_next       : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL SDFOutmux_btfPipe_vld_next       : std_logic;
  SIGNAL dout_10_1_re_tmp                 : signed(41 DOWNTO 0);  -- sfix42_En28
  SIGNAL dout_10_1_im_tmp                 : signed(41 DOWNTO 0);  -- sfix42_En28
...
BEGIN
  ...
  BEGIN
    IF reset = '1' THEN
      ...
      SDFCummutator_btf1_re_dly <= to_signed(0, 42);
      SDFCummutator_btf1_im_dly <= to_signed(0, 42);
