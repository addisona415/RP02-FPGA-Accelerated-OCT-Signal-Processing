-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_10.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_10
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_10_Enb <= '0';
        IF (SDFController_wrState = to_unsigned(16#3#, 2)) AND dout_9_1_vld = '1' THEN 
