-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_8.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_8
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_8_Enb <= '0';
        IF dout_7_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#3#, 2)) THEN 
