-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_1.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_1
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_1_Enb <= '0';
        IF dinXTwdl_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#1FF#, 9)) THEN 
