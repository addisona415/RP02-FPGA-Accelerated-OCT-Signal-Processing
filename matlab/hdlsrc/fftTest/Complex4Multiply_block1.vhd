-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\Complex4Multiply_block1.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF1_7/Complex4Multiply
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Complex4Multiply_block1 IS
  ...
  -- Signals
  SIGNAL din_re_signed                    : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL din_re_reg                       : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL din_im_signed                    : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL din_im_reg                       : signed(38 DOWNTO 0);  -- sfix39_En28
  ...
  SIGNAL prod1_re                         : signed(70 DOWNTO 0) := to_signed(0, 71);  -- sfix71_En58
  SIGNAL prod1_im                         : signed(70 DOWNTO 0) := to_signed(0, 71);  -- sfix71_En58
  SIGNAL prod2_re                         : signed(70 DOWNTO 0) := to_signed(0, 71);  -- sfix71_En58
  SIGNAL prod2_im                         : signed(70 DOWNTO 0) := to_signed(0, 71);  -- sfix71_En58
  ...
  SIGNAL Complex4Add_multRes_re_reg_next  : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL Complex4Add_multRes_im_reg_next  : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL Complex4Add_sub_cast             : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL Complex4Add_sub_cast_1           : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL Complex4Add_add_cast             : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL Complex4Add_add_cast_1           : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL mulResFP_re                      : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL mulResFP_im                      : signed(71 DOWNTO 0);  -- sfix72_En58
  SIGNAL dinXTwdl_re_tmp                  : signed(38 DOWNTO 0);  -- sfix39_En28
  SIGNAL dinXTwdl_im_tmp                  : signed(38 DOWNTO 0);  -- sfix39_En28
