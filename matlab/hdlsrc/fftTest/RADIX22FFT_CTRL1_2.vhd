-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_2.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_2_Enb <= '0';
        IF dout_1_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#FF#, 8)) THEN 
