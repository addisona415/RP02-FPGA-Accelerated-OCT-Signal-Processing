-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_5.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_5
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_5_Enb <= '0';
        IF dinXTwdl_5_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#1F#, 5)) THEN 
