-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_SDF2_2.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_SDF2_2
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF RADIX22FFT_SDF2_2 IS
  ...
  COMPONENT SDFCommutator2
    PORT( clk                             :   IN    std_logic;
          ...
          enb                             :   IN    std_logic;
          dout_1_1_vld                    :   IN    std_logic;
          xf_re                           :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          xf_im                           :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          xf_vld                          :   IN    std_logic;
          dinf_re                         :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          dinf_im                         :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          dinf_vld                        :   IN    std_logic;
          btf1_re                         :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          btf1_im                         :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          btf2_re                         :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          btf2_im                         :   IN    std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          btfout_vld                      :   IN    std_logic;
          wrData_re                       :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
          wrData_im                       :   OUT   std_logic_vector(33 DOWNTO 0);  -- sfix34_En28
  ...
  -- Signals
  SIGNAL dout_1_1_re_signed               : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL din_re                           : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL dout_1_1_im_signed               : signed(32 DOWNTO 0);  -- sfix33_En28
  SIGNAL din_im                           : signed(33 DOWNTO 0);  -- sfix34_En28
  ...
  SIGNAL btf2_im                          : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL btf2_re                          : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL btf1_im                          : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL btf1_re                          : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL dinf_im                          : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL dinf_re                          : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL xf_im                            : signed(33 DOWNTO 0);  -- sfix34_En28
  ...
  SIGNAL x_im_signed                      : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL x_im_dly                         : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL wrData_re                        : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL x_re                             : std_logic_vector(33 DOWNTO 0);  -- ufix34
  SIGNAL x_re_signed                      : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL x_re_dly                         : signed(33 DOWNTO 0);  -- sfix34_En28
  ...
  SIGNAL Radix22ButterflyG2_btf1_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Radix22ButterflyG2_btf1_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Radix22ButterflyG2_btf2_re_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Radix22ButterflyG2_btf2_im_reg_next : signed(34 DOWNTO 0);  -- sfix35_En28
  SIGNAL Radix22ButterflyG2_din_re_dly_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_din_im_dly_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_din_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_x_re_dly_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_x_im_dly_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_x_vld_dly_next : std_logic;
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly1_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly1_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_dinXTwdl_re_dly2_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_dinXTwdl_im_dly2_next : signed(33 DOWNTO 0);  -- sfix34_En28
  SIGNAL Radix22ButterflyG2_multiply_J_dly1_next : std_logic;
  SIGNAL xf_re                            : signed(33 DOWNTO 0);  -- sfix34_En28
...
BEGIN
  ...
  u_SDFCOMMUTATOR_2 : SDFCommutator2
    PORT MAP( clk => clk,
              ...
              xf_re => std_logic_vector(xf_re),  -- sfix34_En28
              xf_im => std_logic_vector(xf_im),  -- sfix34_En28
              xf_vld => xf_vld,
              dinf_re => std_logic_vector(dinf_re),  -- sfix34_En28
              dinf_im => std_logic_vector(dinf_im),  -- sfix34_En28
              dinf_vld => dinf_vld,
              btf1_re => std_logic_vector(btf1_re),  -- sfix34_En28
              btf1_im => std_logic_vector(btf1_im),  -- sfix34_En28
              btf2_re => std_logic_vector(btf2_re),  -- sfix34_En28
              btf2_im => std_logic_vector(btf2_im),  -- sfix34_En28
              btfout_vld => btfout_vld,
              wrData_re => wrData_re,  -- sfix34_En28
              wrData_im => wrData_im,  -- sfix34_En28
              wrAddr => wrAddr,  -- ufix8
              wrEnb => wrEnb,
              dout_2_1_re => dout_2_1_re_tmp,  -- sfix34_En28
              dout_2_1_im => dout_2_1_im_tmp,  -- sfix34_En28
