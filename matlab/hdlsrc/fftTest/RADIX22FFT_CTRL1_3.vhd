-- -------------------------------------------------------------
-- 
-- File Name: hdlsrc\fftTest\RADIX22FFT_CTRL1_3.vhd
...
-- Source Path: fftTest/FFT/RADIX22FFT_CTRL1_3
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
  ...
  BEGIN
    ...
    CASE SDFController_rdState IS
      WHEN "00" =>
        ...
        rd_3_Enb <= '0';
        IF dinXTwdl_3_1_vld = '1' AND (SDFController_wrCount = to_unsigned(16#7F#, 7)) THEN 
